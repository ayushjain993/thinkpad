package io.uhha.common.constant;
...
public class Constant {
    ...
    // google验证前缀
    public static String GoogleAuthName = "UHHA";//谷歌验证前缀
    ...
    // 必须包含字母和数字
//	public static String passwordReg = "^(?![0-9]+$)(?![a-zA-Z]+$)(?![!@#$%^&*\\._]+$)[\\S]{6,}$";
    // 必须包含大小写字母和数字和符号
    public static String passwordReg = "^(?![A-Za-z0-9]+$)(?![a-z0-9\\W]+$)(?![A-Za-z\\W]+$)(?![A-Z0-9\\W]+$)[a-zA-Z0-9\\W]{6,16}$";

    public static int ErrorCountLimit = 10;// 错误N次之后需要等待2小时才能重试
    public static int UserErrorLoginLimit = 7;// 错误N次之后需要等待第二天才能重试
    ...
    public static int APPEXPIRETIME = 7 * 24 * 60 * 60;//app登录过期时间7天
    //每众筹一个btc对应的代币数量
     ...
     * 活动开始时间
     */
    public static final String ACTIVITYSTART = "2021-01-23";
    /**
     * 活动结束时间
     */
    public static final String ACTIVITYEND = "2021-02-02";
