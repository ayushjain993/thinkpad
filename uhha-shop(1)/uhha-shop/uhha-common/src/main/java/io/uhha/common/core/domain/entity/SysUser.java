package io.uhha.common.core.domain.entity;
...
public class SysUser extends BaseEntity
{
    ...
    /**
     * 是否通过实名认证   0 否 1 验证  默认0
     */
    @Excel(name = "是否通过实名认证   0 否 1 验证  默认0  ")
    private String isRealNameScreened;
    ...
    public String getIsRealNameScreened() {
        return isRealNameScreened;
    }

    public void setIsRealNameScreened(String isRealNameScreened) {
        this.isRealNameScreened = isRealNameScreened;
    }
    ...
    public boolean isRealNameScreened(){
        return "1".equalsIgnoreCase(this.isRealNameScreened);
    }
