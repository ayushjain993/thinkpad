...
import io.uhha.coin.common.Enum.SystemTradeTypeEnum;
...
public class SystemTradeType implements Serializable {
	...
	//扩展字段
	private String bCoinNickName;//买方比种别名

	private String sCoinNickName;//卖方比种别名
	...
	public String getbCoinNickName() {
		return bCoinNickName;
	}

	public void setbCoinNickName(String bCoinNickName) {
		this.bCoinNickName = bCoinNickName;
	}

	public String getsCoinNickName() {
		return sCoinNickName;
	}

	public void setsCoinNickName(String sCoinNickName) {
		this.sCoinNickName = sCoinNickName;
	}
