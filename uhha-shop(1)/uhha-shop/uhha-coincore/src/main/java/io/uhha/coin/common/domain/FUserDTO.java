...
public class FUserDTO implements Serializable {
	...
	public Integer getFgooglestatus() {
		return fgooglestatus;
	}

	public void setFgooglestatus(Integer fgooglestatus) {
		this.fgooglestatus = fgooglestatus;
	}
