...
public class ReturnResult implements Serializable {
	...
	public static final int FAULURE_USER_FORBBIN_VALUE=601;
	public static final int FAULURE_OTC_PRICE_VALIDATE=602;
	public static final int FAULURE_TRADE_PWD_VALIDATE=603;
	...
	public static ReturnResult FAULURE_TRADE_PWD_VALIDATE(String msg) {
		ReturnResult rp = new ReturnResult();
		rp.setCode(FAULURE_TRADE_PWD_VALIDATE);
		rp.msg = msg;
		rp.time = System.currentTimeMillis();
		return rp;
	}
	
	public static ReturnResult FAULURE_USER_FORBBIN_VALUE(String msg) {
		ReturnResult rp = new ReturnResult();
		rp.setCode(FAULURE_USER_FORBBIN_VALUE);
		rp.msg = msg;
		rp.time = System.currentTimeMillis();
		return rp;
	}
	
	public static ReturnResult FAULURE_OTC_PRICE_VALIDATE(String msg) {
		ReturnResult rp = new ReturnResult();
		rp.setCode(FAULURE_OTC_PRICE_VALIDATE);
		rp.msg = msg;
		rp.time = System.currentTimeMillis();
		return rp;
	}
