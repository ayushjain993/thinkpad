...
public class DateUtils {
	 ...
	 * @return 某日期的字符串
	 */
	public static synchronized String format(LocalDateTime date, String format) {
		SimpleDateFormat ft = new SimpleDateFormat(format);
	 ...
	 * @return 某日期的字符串
	 */
	public static synchronized String format(LocalDateTime date, DateFormat format) {
		return format.format(date);
	}
