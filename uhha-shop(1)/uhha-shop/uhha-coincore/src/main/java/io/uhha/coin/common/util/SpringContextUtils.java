	...
	private static List<Class> findClasses(File directory, String packageName) throws ClassNotFoundException {
		...
		for (File file : files) {
			if (file.isDirectory()) {
				...
				if (packageName.contains("io.uhha.coin.common.oss")
						|| packageName.contains("io.uhha.coin.common.pay")
						|| packageName.contains("io.uhha.coin.common.util")
						|| packageName.contains("io.uhha.coin.common.redis")) {
					continue;
				}
				// 去掉'.class'
