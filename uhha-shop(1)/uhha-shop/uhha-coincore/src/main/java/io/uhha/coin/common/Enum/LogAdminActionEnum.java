...
public enum LogAdminActionEnum {
	...
	SYSTEM_FINTROUID(60, "修改推荐人"),

	STORE_FROZEN(61, "店铺被冻结"),
	STORE_UNFROZEN(62, "店铺被解冻"),
	STORE_APPROVED(63, "店铺审批被批准"),
	STORE_REFUSED(64, "店铺审批被拒绝"),
	;
