package io.uhha.coin.common.match;
...
public class MathUtils {
	 ...
	 * 人民币显示小数位
	 */
	public static final int DEF_CNY_SCALE = 12;

	/**
	 * 美元显示小数位
	 */
	public static final int DEF_USD_SCALE = 12;

	/**
	 * 虚拟币显示小数位
	 */
	public static final int DEF_COIN_SCALE = 12;
	/**
	 * 手续费显示小数位
	 */
	 ...
	 * 美元输入小数位
	 */
	public static final int ENTER_USD_SCALE = 2;
	/**
	 * 虚拟币输入小数位
	 */
	 ...
	 * @return 是否可用做减法
	 */
	public static boolean checkBalance(BigDecimal a, BigDecimal b){
		if(a==null ||b==null){
			return false;
		}
