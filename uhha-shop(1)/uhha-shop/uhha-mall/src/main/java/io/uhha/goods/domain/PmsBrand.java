...
public class PmsBrand extends BaseEntity {
     ...
     * @param storeId 店铺id
     */
    public static PmsBrand buildCustomizeBrand(String brandName, String createName, long storeId) {
        PmsBrand pmsBrand = new PmsBrand();

        pmsBrand.createName = createName;
        pmsBrand.name = brandName;
        pmsBrand.delFlag = 0;
        pmsBrand.storeId = storeId;
        pmsBrand.customize = 1;
     ...
     * @param storeId 店铺id
     */
    public static PmsBrand buildBrand(String brandName, String createName, long storeId) {
        PmsBrand pmsBrand = new PmsBrand();
