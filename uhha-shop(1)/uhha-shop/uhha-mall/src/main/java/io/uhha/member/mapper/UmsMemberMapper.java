...
public interface UmsMemberMapper {
     ...
     * @return 成功>0
     */
    int updateCustomerFrozenCommission(Map<String, Object> params);
     ...
     * @return 成功>0
     */
    int updateCustomerFrozenCommission2Commission(Map<String, Object> params);
    ...
    /**
     * 更改用户实名状态
     * @param realNameScreened
     * @param customerId
     * @return
     */
    public int changeRealNameStatus(@Param("realnameScreened") String realNameScreened, @Param("customerId") Long customerId);

    /**
     * 更改用户是否能够提现状态
     * @param allowFiatWithdraw
     * @param customerId
     * @return
     */
    public int changeFiatWithdrawStatus(@Param("allowFiatWithdraw") String allowFiatWithdraw, @Param("customerId") Long customerId);

    /**
     * 更改用户是否能够提币状态
     * @param allowCryptoWithdraw
     * @param customerId
     * @return
     */
    public int changeCryptoWithdrawStatus(@Param("allowCryptoWithdraw") String allowCryptoWithdraw, @Param("customerId") Long customerId);

    List<AccountUser> queryNotSettlementAccount();
}
