...
import io.uhha.order.mapper.OmsOrderSkuMapper;
...
public class OmsOrderSkuServiceImpl implements IOmsOrderSkuService {
    ...
    public List<OmsOrderSku> queryByOrderId(long orderId) {
        ...
        List<OmsOrderSku> omsOrderSkus = orderSkuMapper.queryByOrderId(orderId);
        //默认设置可退货数量为OmsOrderSku数量
        omsOrderSkus.forEach(x->x.setReturnNum(x.getNum()));
        return omsOrderSkus;
    }
