...
import io.uhha.coin.common.Enum.validate.SendStatusEnum;
 ...
 * 邮件流水数据模型
 */
public class ValidateEmailDTO implements Serializable {
    private static final long serialVersionUID = -1153177045766635829L;
    private Integer id;
    // 用户id
    private Integer uid;
    // 邮箱
