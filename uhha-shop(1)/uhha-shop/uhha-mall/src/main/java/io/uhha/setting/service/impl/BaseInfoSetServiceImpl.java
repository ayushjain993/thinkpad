...
import io.uhha.setting.mapper.BaseInfoSetMapper;
...
public class BaseInfoSetServiceImpl implements BaseInfoSetService {
     ...
     */
    @Cacheable(value = RedisConstant.BASE_INFO_SET, key = "'BaseInfoSet'")
    @Override
     ...
     */
    @CacheEvict(value = RedisConstant.BASE_INFO_SET, allEntries = true)
    @Override
