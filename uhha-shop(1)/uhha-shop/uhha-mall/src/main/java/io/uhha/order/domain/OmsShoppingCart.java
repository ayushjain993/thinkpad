...
public class OmsShoppingCart extends BaseEntity {
     ...
     */
    @JsonIgnore
    public BigDecimal getSkuDropshipCommissionRate() {
        return Objects.isNull(sku) ? null : sku.getDropshipCommissionRate();
    }
     ...
     * @return 返回单品是否带货单品
     */
    public String getIsDropshipSku() {
        return Objects.isNull(sku) ? "0" : sku.getIsDropship();
    }
