...
public class OrderSettlementRequest {
     ...
     * @return 返回结算请求信息
     */
    public static OrderSettlementRequest build(Long[] ids, String skuInfo, int isGroup, String groupId, Long addressId, Long crowdfundingId, String crowdfundingType, BigDecimal crowdfundingMoney, Long distributeUserId) {
        ...
        orderSettlementRequest.distributeUserId = distributeUserId;
