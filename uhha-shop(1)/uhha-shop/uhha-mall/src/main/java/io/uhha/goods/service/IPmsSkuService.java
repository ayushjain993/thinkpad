...
public interface IPmsSkuService {
     ...
     *
     * @param spuIds  商品id
     * @param isDropship  是否支持带货状态
     * @param storeId 店铺id
     * @return 成功返回>1 失败返回0
     */
    int updateDropshipStatus(List<Long> spuIds, String isDropship, long storeId);
     ...
     * @return 成功返回>0 失败返回0
     */
    int updateCommission(long spuId, BigDecimal commissionRate, BigDecimal sCommissionRate, BigDecimal dropshipCommissionRate, long storeId);
