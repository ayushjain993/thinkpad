...
public class PointSetting {
     ...
     * 发表视频赠送积分
     */
    @ApiModelProperty(value = "发表视频赠送积分")
    private int videoPoint;

    /**
     * 点赞赠送积分
     */
    @ApiModelProperty(value = "点赞赠送积分")
     ...
     * 一个token需要多少积分进行兑换
     */
    @ApiModelProperty(value = "一个token需要多少积分进行兑换")
    private int offsetToken;

    /**
     * 最少起兑
     */
    @ApiModelProperty(value = "最少起兑")
    private int minRedeemToken;

    /**
     * 单次最大可兑换额
     */
    @ApiModelProperty(value = "单次最大可兑换额")
    private int maxRedeemToken;
     ...
     */
    @JsonIgnore
    public boolean checkRedeemSetting(){
        return this.getMaxRedeemToken()>0 && this.getMinRedeemToken()>0 && this.getOffsetToken()>0;
    }
}
