...
public class PmsCommentServiceImpl implements IPmsCommentService {
    ...
    public int addComments(List<PmsComment> comments) {
        ...
        if (!ObjectUtils.isEmpty(pointSetting) && pointSetting.isOpen()) {
            customerPointService.addCustomerPoint(CustomerPoint.buildForComment(comments.get(0).getCustomerId(), pointSetting.getCommentPoint()));
        }
