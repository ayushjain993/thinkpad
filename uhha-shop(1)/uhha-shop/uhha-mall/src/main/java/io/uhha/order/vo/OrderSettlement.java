...
public class OrderSettlement {
     ...
     * @return 返回订单结算信息
     */
    public static OrderSettlement build(Long[] ids, String skuInfo, UmsMemberAddress customerAddress, List<StoreSettlement> storeSettlements, Long distributeUserId) {
        OrderSettlement orderSettlement = new OrderSettlement();
        orderSettlement.customerAddress = customerAddress;
        orderSettlement.ids = ids;
        orderSettlement.skuInfo = skuInfo;
        orderSettlement.distributeUserId = distributeUserId;
