...
public interface IOmsOrderService {
     ...
     * @return 成功返回1 失败返回0
     */
    int deleteOrder(long id, long storeId);
     ...
     * @return 返回订单信息
     */
    List<OmsOrder> queryOrderByOrderCode(String orderCode, OrderItem... orderItems);
     ...
     * @return 查看物流url
     */
    QueryTrackResp getShippingDetails(long orderId, long customerId) throws Exception;
     ...
     * @param list
     */
    void buildOrderDetail(List<OmsBillingRecords> list);

    SettlementStatics buildSettlementRecordStatics(List<OmsBillingRecords> list, Long storeId);
}
