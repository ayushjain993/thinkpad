...
public class AreaServiceImpl implements AreaService {
    ...
    @Cacheable(value = RedisConstant.AREA, key = "'AREA'+#areaItems.hashCode()")
    @Override
    ...
    @Override
    public List<LsProvince> queryProvincesByCountryId(long countryId) {
        logger.debug("queryProvincesByCountryId.....countryId:{}", countryId);
        return areaMapper.queryProvincesByCountryId(countryId);
    }
    ...
    @CacheEvict(value = RedisConstant.AREA, allEntries = true)
    @Override
