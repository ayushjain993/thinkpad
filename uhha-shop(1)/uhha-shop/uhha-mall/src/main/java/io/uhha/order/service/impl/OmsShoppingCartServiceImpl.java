...
import io.uhha.order.mapper.OmsShoppingCartMapper;
import io.uhha.order.service.IOmsShoppingCartService;
import io.uhha.order.vo.ShoppingCartNum;
...
public class OmsShoppingCartServiceImpl implements IOmsShoppingCartService {
    ...
    @Override
    public int deleteShoppingCart(long customerId, Long[] skuIds) {
        logger.debug("deleteShoppingCart customerId:{} \r\n skuIds:{}", customerId, skuIds);
        ...
        for (Long id : skuIds) {
            ...
            params.put("skuId", id);
            shoppingCartMapper.deleteShoppingCart(params);
        }
