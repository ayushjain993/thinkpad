...
import io.uhha.member.mapper.WeChatCustomerLinkMapper;
...
public class WeChatCustomerLinkServiceImpl implements WeChatCustomerLinkService {
    ...
    @CacheEvict(value = RedisConstant.WE_CHAT_CUSTOMER_LINK, key = "'WE_CHAT_CUSTOMER_LINK'+#weChatCustomerLink.unionId")
    @Override
    ...
    @Cacheable(value = RedisConstant.WE_CHAT_CUSTOMER_LINK, key = "'WE_CHAT_CUSTOMER_LINK'+#unionId")
    @Override
    ...
    @CacheEvict(value = RedisConstant.WE_CHAT_CUSTOMER_LINK, key = "'WE_CHAT_CUSTOMER_LINK'+#unionId")
    @Override
