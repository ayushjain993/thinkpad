...
import io.uhha.goods.domain.StoreSpu;
...
public interface IPmsGoodsService {
     ...
     *
     * @param spuIds   商品id集合
     * @param status   支持带货状态  0带货 1不带货
     * @param storeId  店铺id
     * @param consumer 回调通知es 建立索引
     * @return 成功返回>1  失败返回0
     */
    public int updateSpuDropshipStatus(List<Long> spuIds, String status, long storeId, Consumer<Long> consumer);
     ...
     * @return 成功返回>0 失败返回0
     */
    int updateCommission(long id, BigDecimal commissionRate, BigDecimal sCommissionRate, BigDecimal dropshipCommissionRate, long storeId);
     ...
     * @param commissionRate  佣金比例
     * @param sCommissionRate 二级佣金比例
     * @param dropshipCommissionRate 带货佣金比例
     * @param storeId         店铺id
     * @return 成功返回1 失败返回0
     */
    int updateCommissions(List<Long> ids, BigDecimal commissionRate, BigDecimal sCommissionRate, BigDecimal dropshipCommissionRate, long storeId);
     ...
     * @return
     */
    List<PmsGoods> queryAllStoreAuditdSpusByStatus(String status);
}
