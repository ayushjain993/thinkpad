...
import io.uhha.order.vo.MarketingOrderStatistics;
import io.uhha.order.vo.StoreSaleAmount;
...
public interface OmsOrderMapper {
    ...
    public OmsOrder queryCommunityOrdersByOrderCode(String orderCode);

    public OmsOrder queryOrderByBackCode(@Param("backCode") String backCode);
}
