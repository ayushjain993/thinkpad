...
public class LsPaySetting extends BaseEntity {
    ...
    /**
     * 支付方式 1:支付宝 2:微信 3:银联 4:预存款 5:微信APP支付 6:微信小程序支付 7: 2c2p支付 8: dlocal 9: zotapay
     */
    @Excel(name = "支付方式 1:支付宝 2:微信 3:银联 4:预存款 5:微信APP支付 6:微信小程序支付 7:2c2p支付 8: dlocal 9: zotapay")
