...
public interface TStoreInfoMapper {
     ...
     * @return
     */
    int updateMerchantTypeOrFee(@Param("storeId") Long storeId, @Param("merchantType") String merchantType, @Param("platformFeeRate") BigDecimal platformFeeRate);
    ...
    int changeFreezeStatus(TStoreInfo storeInfo);
     ...
     * @return
     */
    TStoreInfo queryStoreByStoreId(Long storeId);
