...
public interface IUmsMemberService {
     ...
     * @return 成功返回>0
     */
    int updateCustomerFrozenCommission(long customerId, BigDecimal commission);
     ...
     * @return 成功返回>0
     */
    int updateCustomerFrozenCommission2Commission(long customerId, BigDecimal commission);
    ...
    UmsMember getUser(Long userId);

    int changeRealNameStatus(String realnameStatus, Long userId);
