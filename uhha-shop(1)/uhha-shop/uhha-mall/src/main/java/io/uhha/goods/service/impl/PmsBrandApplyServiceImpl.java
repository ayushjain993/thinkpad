...
import io.uhha.goods.mapper.PmsBrandApplyMapper;
...
public class PmsBrandApplyServiceImpl implements IPmsBrandApplyService {
    ...
    public PmsBrandApply selectPmsBrandApplyById(Long id) {
        return brandApplyMapper.selectPmsBrandApplyById(id);
    }
    ...
    public List<PmsBrandApply> selectPmsBrandApplyList(PmsBrandApply pmsBrandApply) {
        return brandApplyMapper.selectPmsBrandApplyList(pmsBrandApply);
    }

    @Override
    public List<PmsBrandApply> selectPmsBrandApplyByStatus(String status) {
        return brandApplyMapper.queryBrandApplyByStatus(status);
    }
    ...
    public int insertPmsBrandApply(PmsBrandApply pmsBrandApply) {
        ...
        return brandApplyMapper.insertPmsBrandApply(pmsBrandApply);
    }
    ...
    public int updatePmsBrandApply(PmsBrandApply pmsBrandApply) {
        return brandApplyMapper.updatePmsBrandApply(pmsBrandApply);
    }
    ...
    public int deletePmsBrandApplyByIds(Long[] ids) {
        return brandApplyMapper.deletePmsBrandApplyByIds(ids);
    }
    ...
    public int deletePmsBrandApplyById(Long id) {
        return brandApplyMapper.deletePmsBrandApplyById(id);
    }
}
