...
public class BackOrderServiceApiImpl implements BackOrderServiceApi {
    ...
    @Transactional
    @Override
    public int applyRefundOrder(ApplyBackOrderParams applyBackOrderParams) {
        Long customerId = applyBackOrderParams.getCustomerId();
        Long orderId = applyBackOrderParams.getOrderId();
        String reason = applyBackOrderParams.getReason();
        String desc = applyBackOrderParams.getDescription();
        ...
        logger.debug("applyRefundOrder queryOrder order:{}", JSON.toJSONString(order));
        ...
        //发送通知
        mallNotifyHelper.applyRefundOrder(applyBackOrderParams);
    ...
    public int applyReturnOrder(ApplyReturnParams applyReturnParams) {
        ...
        //发送通知
        mallNotifyHelper.applyReturnOrder(applyReturnParams);
    ...
    public int agreeToRefund(Long backOrderId, Long storeId, String message) {
        ...
        // 修改订单状态
        orderService.updateOrderBack(backOrder.getOrderId(), BackOrderStatusEnum.RETURN_APPROVED_NEEDS_LOGISTIC.getCode());
        ...
        //发送通知
        mallNotifyHelper.agreeToRefund(backOrderId, message);
    ...
    public int confirmReturn(Long backOrderId, Long storeId, String message, BigDecimal money) {
        ...
        // if (StringUtils.equals("1", backOrder.getIsDropship())) {
        ...
        billingRecordService.insertOmsBillingRecords(OmsBillingRecords.buildForReturnDropshipOrder(setBackOrderStoreName(backOrder), defaultDropshipPart));
        //  }
        ...
        //发送通知
        mallNotifyHelper.confirmReturn(backOrderId, message, money);
