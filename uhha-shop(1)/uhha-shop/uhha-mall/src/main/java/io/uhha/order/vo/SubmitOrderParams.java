...
import io.uhha.common.enums.OrderSourceEnum;
import lombok.Data;
...
public class SubmitOrderParams {
    ...
    public void setFromApp() {
        this.source = OrderSourceEnum.APP.getCode();
    }
    ...
    public void setFromApplets() {
        this.source = OrderSourceEnum.APPLET.getCode();
    }
    ...
    public void setFromPc() {
        this.source = OrderSourceEnum.PC.getCode();
    }
    ...
    public void setFromMobile() {
        this.source = OrderSourceEnum.H5.getCode();
    }
    ...
    public static class StoreInfo {
         ...
         * @see io.uhha.common.enums.PayTypeEnum
         */
