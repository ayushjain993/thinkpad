 ...
 * 消息模板数据模型
 */
public class ValidateTemplateDTO implements Serializable {
    private static final long serialVersionUID = 5863393351925005180L;
    private Integer id;
    // 模板类型
    ...
    //系统使用版本:0代表公用，1代表1.0使用，2代表2.0使用
    ...
    public String getBusinessType_s() {
        ...
        for(int i = 0; i < types.length; i++){
            businessType_s.append(BusinessTypeEnum.getEnValueByCode(Integer.valueOf(types[i]))).append(";");
        }
