...
public class OrderMessageCount {
    ...
    private String frozenCommissionMoney; //冻结佣金额

    private String withdrawMoney;// 累计提现

    private String pointsTotal; //累积积分
    /**
     * 增加余额
     *
     ...
     * @return 返回当前对象
     */
    public OrderMessageCount addToFrozenCommissonMoney(String commissonMoney) {
        this.frozenCommissionMoney = commissonMoney;
        return this;
    }
     ...
     * @return 返回当前对象
     */
    public OrderMessageCount addToFrozenBalance(String frozenBalance) {
     ...
     * 积分
     *
     * @param pointsTotal 积分总额
     * @return 返回当前对象
     */
    public OrderMessageCount addToPointsTotal(String pointsTotal) {
