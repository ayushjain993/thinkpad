...
public class SkuResponse {
    ...
    public static SkuResponse build(OmsShoppingCart shoppingCart) {
        ...
        skuResponse.isDropship = shoppingCart.getIsDropshipSku();
        skuResponse.dropshipCommissionRate = shoppingCart.getSkuDropshipCommissionRate();
        ...
        skuResponse.distributeUserId = shoppingCart.getDistributeUserId();
        return skuResponse;
    }
