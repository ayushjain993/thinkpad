...
import io.uhha.marketing.domain.PanicBuy;
import io.uhha.marketing.domain.SeckillScene;
import io.uhha.marketing.domain.SeckillScenePanicbuy;
import io.uhha.marketing.domain.SeckillSeceneStore;
import io.uhha.marketing.mapper.SeckillSeceneStoreMapper;
import io.uhha.marketing.service.MarketingService;
import io.uhha.marketing.service.SeckillScenePanicbuyService;
import io.uhha.marketing.service.SeckillSceneService;
import io.uhha.marketing.service.SeckillSeceneStoreService;
 ...
 * 店铺参与秒杀活动的关联服务接口实现类
 *
 * @author mj created on 2020/5/14
 */
@Service
@Slf4j
