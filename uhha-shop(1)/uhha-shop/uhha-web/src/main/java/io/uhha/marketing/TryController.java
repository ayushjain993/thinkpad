...
import io.uhha.marketing.service.impl.TryReportService;
...
public class TryController {
     ...
     * @return 试用商品详情
     */
    @RequestMapping(value = "/tryspudetail", method = RequestMethod.GET)
    @UnAuth
     ...
     */
    @UnAuth
    @RequestMapping(value = "/storescore", method = RequestMethod.GET)
     ...
     */
    @UnAuth
    @RequestMapping(value = "/tryskuapplybytryid", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/applytrysku", method = RequestMethod.POST)
     ...
     * @return 试用报告集合
     */
    @RequestMapping(value = "/tryreportlist", method = RequestMethod.GET)
    @UnAuth
     ...
     * @return 试用促销图片信息
     */
    @RequestMapping(value = "/try/pic", method = RequestMethod.GET)
