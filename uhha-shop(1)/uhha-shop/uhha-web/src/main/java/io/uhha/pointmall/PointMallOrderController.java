package io.uhha.pointmall;


import io.uhha.appletsutil.AppletsLoginUtils;
import io.uhha.common.core.domain.AjaxResult;
import io.uhha.integral.domain.PointMallOrder;
import io.uhha.integral.domain.QueryCriteria;
import io.uhha.integral.service.PointMallOrderService;
import io.uhha.integral.service.PointMallOrderServiceApi;
import io.uhha.order.vo.PointOrderMessageCount;
 ...
 * 积分商城订单控制器
 *
 * @author mj created on 2020/4/22
 */
@Controller
@Api(tags = "积分商城订单接口")
