...
public class SmsHomeNewProductController extends BaseController {
    ...
    public TableDataInfo list(SmsHomeNewProduct smsHomeNewProduct) {
        startPage();
        smsHomeNewProduct.setStoreId(CommonConstant.ADMIN_STOREID);
    ...
    public AjaxResult create(@RequestBody List<SmsHomeNewProduct> homeNewProducts) {
        ...
        for (SmsHomeNewProduct smsNewProduct : homeNewProducts) {
            ...
            smsNewProduct.setStoreId(CommonConstant.ADMIN_STOREID);
    ...
    public AjaxResult remove(@PathVariable Long[] ids) {
        return toAjax(smsHomeNewProductService.deleteSmsHomeNewProductByIds(ids,CommonConstant.ADMIN_STOREID));
    }
    ...
    public Object updateRecommendStatus(@RequestParam("ids") Long[] ids, @RequestParam("recommendStatus") Integer recommendStatus) {
        int count = smsHomeNewProductService.updateRecommendStatus(ids, recommendStatus,CommonConstant.ADMIN_STOREID);
        return toAjax(count);
    }
    ...
    public Object updateSort(@PathVariable Long id, @PathVariable Integer sort) {
        int count = smsHomeNewProductService.updateSort(id, sort,CommonConstant.ADMIN_STOREID);
        return toAjax(count);
    }
}
