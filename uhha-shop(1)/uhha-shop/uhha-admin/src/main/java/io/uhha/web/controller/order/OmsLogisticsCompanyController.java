...
public class OmsLogisticsCompanyController extends BaseController {
    ...
    public TableDataInfo list() {
        startPage();
        List<OmsLogisticsCompany> list = omsLogisticsCompanyService.selectOmsLogisticsCompanyListByStoreId(CommonConstant.ADMIN_STOREID);
    ...
    public TableDataInfo listForStore() {
        startPage();
        List<OmsLogisticsCompanyVo> list = omsLogisticsCompanyService.selectOmsLogisticsCompanyForStore(CommonConstant.ADMIN_STOREID);
        return getDataTable(list);
    }
    ...
    public AjaxResult add(@RequestBody OmsLogisticsCompany omsLogisticsCompany) {
        ...
        omsLogisticsCompanyUse.setStoreId(CommonConstant.ADMIN_STOREID);
